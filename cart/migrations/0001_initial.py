# Generated by Django 5.2.7 on 2026-01-08 20:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Нове замовлення'), ('done', 'Виконано')], default='new', max_length=10, verbose_name='Статус')),
